            ...
            <div class="col-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div id='loadingmessage' style='display:none;width:50px;height:50px;left : 32%;top : 32%;z-index: 9999;position : absolute;'><img src="<?php echo e(url('/public/images/mz-loader-2.gif')); ?>"/></div>
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gujaratigraphics.com/public_html/MZFitnezz/resources/views/employeeSchedule/view.blade.php ENDPATH**/ ?>