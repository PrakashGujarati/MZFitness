...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('/public/assets/clock/css/bootstrap.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('/public/assets/clock/semantic-ui/semantic.min.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('/public/assets/clock/css/clock.css')}}">
    ...
    <img src="{{asset('public/images/clock-background.png')}}" class="wave">
    <div class="wrapper">
    ...
    <script src="{{asset('/public/assets/clock/js/jquery-3.3.1.min.js')}}"></script>
    <script src="{{asset('/public/assets/clock/semantic-ui/semantic.min.js')}}"></script>
    <script src="{{asset('/public/assets/clock/js/script.js')}}"></script>
    <script src="{{asset('/public/assets/clock/js/bootstrap.min.js')}}"></script>
